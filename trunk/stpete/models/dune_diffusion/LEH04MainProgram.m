...
clear zTemp xTemp
shift = xF(end)-x(end)
xM = [0:1:max(xF(end)-min(xF), x(end)-min(x))]; %put this on a uniform grid
zTemp = z;
clear z;
...
g = 9.81;
Bo = 0.9471./(85-64);  %initial beach slope, between dune toe and z=0, Dec. 2008 fig.
Btfac = (2.183-.9471)./(112-85)./Bo;  %slope at which beta receeds. LEH04 = 1, PH11 = 0.54.... 
Bt = Bo*Btfac;
Bf = 2.183./(112-79);   %final beach slope
zb(1) = 0.947;   %based on DEc. 2008 survey, regression fit. See fig.
